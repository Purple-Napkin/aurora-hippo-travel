...
import { Plane, ShoppingBasket, ArrowRight, Search } from "lucide-react";
...
/**
 * Trip bundle PDP: Holmes chips, intent, and contextual hints aligned with travel styling.
 */
export function RecipeHolmesExperience({
  ...
  return (
    <section
      ...
      aria-label="Personalised for your trip"
    >
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-xl text-sm leading-snug text-aurora-muted">
                ...
                helpful routes and shortcuts that fit your plans. Nothing extra to set up.
              </p>
            </div>
          </div>
          {showMission ? (
