...
const siteName = process.env.NEXT_PUBLIC_SITE_NAME ?? "Example Travel";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8">
          <div>
            ...
            <p className="text-aurora-muted text-sm">
              Plan trips and book experiences — storefront and checkout powered by Aurora. Customize this template for your travel brand.
            </p>
          </div>
          <div>
