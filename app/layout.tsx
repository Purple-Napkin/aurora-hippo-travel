...
const siteName =
  process.env.NEXT_PUBLIC_SITE_NAME ?? "Example Travel";

/** Vertical default; Studio `accent_color` or `NEXT_PUBLIC_ACCENT_COLOR` override. */
